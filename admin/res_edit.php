...
if (isset($_POST['update'])) {
    ...
    $query = $conn->prepare("UPDATE upload_res SET reference_number = :resolutionNumber, date_time = :date, proponent = :proponent, seconded = :seconded, committe = :committee WHERE id = :id");
    $query->execute(array(
