...
if(isset($_POST['add'])){
    ...
    if($move){
        $query = $conn->query("INSERT INTO upload_cso(name,fname) VALUES('$name','$fname')");
        if($query){
...
$query = $conn->prepare("SELECT * FROM upload_cso ORDER BY id DESC LIMIT :limit OFFSET :offset");
                    ...
                    <tbody id="dataTable">
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;">
                                <a href="view_cso.php?filename=<?php echo $row['id'];?>&f=<?php echo $row['fname'] ?>"><?php echo $row['name'] ?></a>
                            </td>
