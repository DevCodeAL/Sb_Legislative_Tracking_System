...
if (isset($_GET['filename'])) {
    ...
    $sql = "UPDATE upload_ord SET view_count = view_count + 1 WHERE id = ?";
...
$sql = "SELECT view_count FROM upload_ord WHERE id = ?";
$stmt = $conn->prepare($sql);
...
$stmt->close();
            ...
            $stmt = $conn->prepare("SELECT * FROM upload_ord WHERE id = ?"); // Correct SQL
        ...
        <div class="file-viewer">
            ...
            function docToPdf($docFilePath) {
                ...
                $pdfFilePath = 'admin/upload_ord/' . time() . '.pdf';
            ...
            $file_path = 'admin/upload_ord/' . $_REQUEST['f'];
