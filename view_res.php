...
if (isset($_GET['filename'])) {
    ...
    $sql = "UPDATE upload_res SET view_count = view_count + 1 WHERE id = ?";
...
$sql = "SELECT view_count FROM upload_res WHERE id = ?";
$stmt = $conn->prepare($sql);
...
$stmt->close();
            ...
            $stmt = $conn->prepare("SELECT * FROM upload_res WHERE id = ?"); // Correct SQL
        ...
        <div class="file-viewer">
            ...
            function docToPdf($docFilePath) {
                ...
                $pdfFilePath = 'admin/upload_res/' . time() . '.pdf';
            ...
            $file_path = 'admin/upload_res/' . $_REQUEST['f'];
