<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $stmt = mysqli_prepare($conn, "INSERT INTO `kgwd4-db` (`fullname`, `gender`, `date_of_birth`, `citizenship`, `civil_status`, `term`, `position`, `address`, `contact_number`, `email`, `ec_name`, `ec_number`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)");
