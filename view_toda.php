...
if (isset($_GET['filename'])) {
    ...
    $sql = "UPDATE upload_toda SET view_count = view_count + 1 WHERE id = ?";
...
<body>
    ...
    <div class="containers">
        <div class="memo">
            <h4>Trycicle Operators and Driver's Association</h4>
        </div>
        <?php
...
$sql = "SELECT view_count FROM upload_toda WHERE id = ?";
$stmt = $conn->prepare($sql);
...
$stmt->close();
            ...
            $stmt = $conn->prepare("SELECT * FROM upload_toda WHERE id = ?"); // Correct SQL
        ...
        <div class="file-viewer">
            ...
            function docToPdf($docFilePath) {
                ...
                $pdfFilePath = 'admin/toda/' . time() . '.pdf';
            ...
            $file_path = 'admin/toda/' . $_REQUEST['f'];
