...
if(isset($_POST['add'])){
    ...
    if($move){
        $query = $conn->query("INSERT INTO upload_toda(name,fname) VALUES('$name','$fname')");
        if($query){
...
$query = $conn->prepare("SELECT * FROM upload_toda ORDER BY id DESC LIMIT :limit OFFSET :offset");
...
<html>
    ...
    <h3 style="background-color: #ab1703; color: white; text-align: center; "><p>ISSUANCES ARCHIVE</p></h3> 
        <div style="color: black; width: 100%; text-align: center;">
            <h5>TRYCICLE OPERATORS AND DRIVER ORGANIZATION</h5>
        </div>
                    ...
                    <tbody id="dataTable">
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;">
                                <a href="view_toda.php?filename=<?php echo $row['id'];?>&f=<?php echo $row['fname'] ?>"><?php echo $row['name'] ?></a>
                            </td>
