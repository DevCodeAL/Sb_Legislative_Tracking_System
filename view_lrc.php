...
<head>
    ...
    <title>Land ReClassification File</title>
</head>
...
$sql = "SELECT view_count FROM upload_lrc WHERE id = ?";
$stmt = $conn->prepare($sql);
...
$stmt->close();
            ...
            $stmt = $conn->prepare("SELECT * FROM upload_lrc WHERE id = ?"); // Correct SQL
        ...
        <div class="file-viewer">
            ...
            function docToPdf($docFilePath) {
                ...
                $pdfFilePath = 'admin/lrc/' . time() . '.pdf';
            ...
            $file_path = 'admin/lrc/' . $_REQUEST['f'];
